...
class RepositoryEvent(Event):
    ...
    def __init__(self, repository_type: EventType, id: str, name: str, url: str, attrs=None, data: dict = {}):
        """Initializes class.
        """
...
class RepositoryCreatedEvent(RepositoryEvent):
    ...
    def __init__(self, id: str=None, name: str=None, url: str=None, attrs=None, data: dict = {}):
        """Initializes class.
        """
        self._event_type: str = EventType.RepositoryCreatedEventV1

        super().__init__(repository_type=self._event_type, id=id, name=name, url=url, attrs=attrs, data=data)
