...
from cdevents.core.env import EnvEvent, EnvEventCreatedEvent, EnvEventModifiedEvent, EnvEventDeletedEvent
from cdevents.core.event_type import EventType

@pytest.mark.unit
def test_environment_created():
    env_event = EnvEvent(env_type=EventType.EnvironmentCreatedEventV1, id="_id", name="_name", repo="_repo", data={"key1": "value1"})
