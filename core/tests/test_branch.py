...
def test_repository_branch_created():
    branch_event = Branch(branch_type=BranchType.BranchCreatedEventV1, id="_id", name="_name", repoid="_repoid", data={"key1": "value1"})
...
def test_repository_branch_deleted():
    branch_event = Branch(branch_type=BranchType.BranchDeletedEventV1, id="_id", name="_name", repoid="_repoid", data={"key1": "value1"})
    assert branch_event is not None
