...
from cdevents.core.branch import BranchEvent, BranchCreatedEvent, BranchDeletedEvent

@pytest.mark.unit
def test_branch_created():
    branch_event = BranchEvent(branch_type=EventType.BranchCreatedEventV1, id="_id", name="_name", repoid="_repoid", data={"key1": "value1"})
