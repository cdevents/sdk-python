...
def test_pipelinerun_created():
    pipelinerun_event = PipelinerunEvent(
        pipelinerun_type=EventType.PipelineRunStartedEventV1,
        id="_id",
        name="_name",
        status="_status",
        url="_url",
    ...
    assert pipelinerun_event._attributes["extensions"] == {
        "pipelinerunid": "_id",
        "pipelinerunname": "_name",
        "pipelinerunstatus": "_status",
        "pipelinerunurl": "_url",
        "pipelinerunerrors": "_errors",
    }
