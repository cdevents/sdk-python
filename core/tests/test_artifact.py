...
from cdevents.core.artifact import ArtifactEvent, ArtifactPackagedEvent, ArtifactPublishedEvent

@pytest.mark.unit
def test_artifact_created():
    artifact_event = ArtifactEvent(artifact_type=EventType.ArtifactPackagedEventV1, id="_id", name="_name", version="_version",data={"key1": "value1"})
