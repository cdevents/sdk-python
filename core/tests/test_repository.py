...
from cdevents.core.repository import RepositoryEvent, RepositoryCreatedEvent, RepositoryModifiedEvent, RepositoryDeletedEvent
from cdevents.core.event_type import EventType

@pytest.mark.unit
def test_repository_created():
    repository_event = RepositoryEvent(repository_type=EventType.RepositoryCreatedEventV1, id="_id", name="_name", url="_url", data={"key1": "value1"})
